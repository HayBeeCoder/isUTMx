// // Modified main.cpp with bending test support
...
//   THIRD = 3,
//   FOURTH = 4,
//   FOURTH_ONE = 41, // Compression subpage for bending selection
//   FIFTH = 5,
//   FIFTH_ONE = 51,
//   FIFTH_TWO = 52,
...
// // Modified fourth page UI to handle compression subpage
...
// //   u8g2.setCursor(3, 56);
// //   u8g2.print("HOLD 3 DOWN FOR TORSION");
...
//     }
//     fifth_page_ui(u8g2, SELECTED_PAGE, SELECTED_PAGE_ADDRESS, key, selectedTest(), MAX_FORCE_ADDRESS, input_value, SENSOR_RATING_IN_KG, TARGET_FORCE, SELECTED_PAGE, TARGET_EXTENSION, TARGET_EXTENSION_ADDRESS, TARGET_SPEED, "150");
//   }
...
//       {
//         // Go to compression subpage instead of directly selecting compression
...
//       EEPROM.get(SELECT_TEST_VALUE_ADDRESS, SELECTED_TEST_VALUE);
//     }
//     else if (SELECTED_PAGE == FOURTH_ONE) // Handle compression subpage
//     {
//       if (key - '0' == FIRST)
//       {
...
//         EEPROM.put(SELECTED_PAGE_ADDRESS, FIFTH);
//         Serial2.println("bending"); // Send test type to Arduino Nano
//       }
//       else if (key == '*')
//       {
//         // Go back to main test selection page
