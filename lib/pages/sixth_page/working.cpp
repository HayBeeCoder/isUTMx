...
// void handle_current_status_logic(Status &current_status, String &target_force, String &target_extension, char &key, String test);
...
// {
//     // Pass the test type to handle_current_status_logic
//     handle_current_status_logic(current_status, target_force, target_extension, key, test);
...
// void handle_broadcast(float force, float displacement, String target_force)
// {
//     // This function can be used for additional broadcast handling if needed
// }
...
// void handle_current_status_logic(Status &current_status, String &target_force, String &target_extension, char &key, String test)
// {
//     // Updated function signature to include test parameter for proper broadcasting
